...
router.put('/:gameId/settings', auth, async (req, res) => {
  try {
    ...
    const fields = {
      ...
      heading_1_color: s.heading_1_color || '#776e65',
      heading_2_color: s.heading_2_color || '#776e65',
      heading_3_color: s.heading_3_color || '#776e65',
      description_text: s.description_text || '',
      description_color: s.description_color || '#776e65',
      bg_color: s.bg_color || '#faf8ef',
      primary_color: s.primary_color || '#8f7a66',
