 ...
 * Superseded by module: games/bowling/route.js
...
const SETTINGS_TABLE = 'bowling_settings';
...
router.put('/:gameId/settings', auth, upload.fields([
  ...
  const { frames, pins, difficulty, heading_1, heading_2, heading_3, description_text,
  ...
  try {
    ...
    const fields = {
      frames: n(frames, e.frames || 10), pins: n(pins, e.pins || 10),
      ...
      sound_roll_id: n(sound_roll_id, e.sound_roll_id), sound_strike_id: n(sound_strike_id, e.sound_strike_id),
      sound_spare_id: n(sound_spare_id, e.sound_spare_id),
