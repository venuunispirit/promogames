 ...
 * Superseded by module: games/hanoi/route.js
...
const SETTINGS_TABLE = 'hanoi_settings';
...
router.put('/:gameId/settings', auth, upload.fields([
  ...
  try {
    ...
    const fields = {
      ...
      sound_move_id: n(sound_move_id, e.sound_move_id), sound_complete_id: n(sound_complete_id, e.sound_complete_id),
