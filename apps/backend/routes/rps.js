 ...
 * Superseded by module: games/rps/route.js
...
const SETTINGS_TABLE = 'rps_settings';
...
router.put('/:gameId/settings', auth, upload.fields([
  ...
  const { rounds, difficulty, heading_1, heading_2, heading_3, description_text,
  ...
  try {
    ...
    const fields = {
      rounds: n(rounds, e.rounds || 5), difficulty: difficulty || e.difficulty || 'medium',
      ...
      sound_win_id: n(sound_win_id, e.sound_win_id), sound_lose_id: n(sound_lose_id, e.sound_lose_id),
      sound_draw_id: n(sound_draw_id, e.sound_draw_id),
