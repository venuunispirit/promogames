    ...
    <div className="bol-page">
      <style>{`
        ...
        .bol-search input { padding:11px 14px 11px 38px; border-radius:12px; border:1.5px solid #e2e8f0; font-size:13px;
          font-family:inherit; width:260px; background:#fff; outline:none; transition:border-color .15s, box-shadow .15s; }
        .bol-search input:focus { border-color:var(--indigo); box-shadow:0 0 0 4px rgba(99,102,241,.12); }
        ...
        .bol-card { text-align:left; background:#fff; border:1px solid #eef0f5; border-radius:18px; padding:20px;
        ...
        .bol-card::before { content:''; position:absolute; inset:0 0 auto 0; height:4px;
          background:linear-gradient(90deg,var(--indigo),var(--violet)); opacity:0; transition:opacity .15s; }
        ...
        .bol-avatar { width:46px; height:46px; border-radius:13px; flex-shrink:0;
          background:linear-gradient(135deg,var(--indigo),var(--violet)); color:#fff; display:flex; align-items:center;
        ...
        .bol-modal { background:#fff; border-radius:20px; width:100%; max-width:1080px; box-shadow:0 30px 80px rgba(0,0,0,.3);
        ...
        .bol-btn-primary { background:#fff; color:#5b21b6; }
        ...
        .bol-field input:focus { border-color:var(--indigo); }
        .bol-apply { padding:9px 18px; border-radius:9px; border:none; background:var(--indigo); color:#fff; font-size:12.5px; font-weight:700; cursor:pointer; font-family:inherit; }
