    ...
    <div style={{ fontFamily: "'DM Sans',sans-serif", padding: '24px 0' }}>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
        ...
        <button onClick={exportCSV}
          style={{ padding:'8px 16px', borderRadius:8, border:'1.5px solid var(--border)', background:'var(--surface)', cursor:'pointer', fontSize:12, fontWeight:600, color:'var(--text)', fontFamily:'inherit' }}>
          Export CSV
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign:'center', padding:40, color:'var(--text3)' }}>No redemptions found</div>
      ) : (
          ...
          <table style={{ width:'100%', borderCollapse:'collapse', fontSize:12 }}>
            <thead>
              <tr style={{ background:'var(--surface2)', borderBottom:'1px solid var(--border)' }}>
                ...
                <th style={{ padding:'10px 12px', textAlign:'left', fontWeight:700, color:'var(--text)' }}>Game</th>
            ...
            <tbody>
              {redemptions.map(r => (
                <tr key={r.id} style={{ borderBottom:'1px solid var(--border-light)' }}>
                  ...
                  <td style={{ padding:'10px 12px', color:'var(--text)' }}>{r.game_name}</td>
