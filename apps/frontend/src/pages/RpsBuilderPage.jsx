...
export default function RpsBuilderPage() {
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      const fields = ['rounds','difficulty',
        ...
        'sound_win_id','sound_lose_id','sound_draw_id',
      ...
      await api.put(`/rps/${id}/settings`, fd)
    ...
    <>
      <div className="gb-section">
        ...
        <div className="gb-row">
          <div className="gb-field"><label>Rounds</label><input type="number" value={s('rounds', 5)} onChange={e => set('rounds', e.target.value)} /></div>
          <div className="gb-field"><label>AI Difficulty</label>
  ...
  const renderSounds = () => (
    <div className="gb-section">
      ...
      <div className="gb-row">
        ...
        <SoundSelector label="Lose Sound" value={s('sound_lose_id')} onChange={v => set('sound_lose_id', v)} sounds={sounds} />
        <SoundSelector label="Draw Sound" value={s('sound_draw_id')} onChange={v => set('sound_draw_id', v)} sounds={sounds} />
      </div>
        ...
        <div className="gb-h-left">
          ...
          <div>
            {editingName ? (
              ...
              <h1 className="gb-title" onClick={() => { setNameInput(game?.name || ''); setEditingName(true) }}>{game?.name || 'RPS Game'}</h1>
            )}
            <div className="gb-subtitle">✊ Rock Paper Scissors</div>
          </div>
        </div>
        ...
        <div className="gb-phone-col">
          <div className="gb-phone">
            <div style={{ padding: 16, textAlign: 'center' }}>
              ...
              <div style={{ marginTop: 8, fontSize: 12, color: '#666' }}>{s('rounds', 5)} rounds · {s('difficulty', 'medium')}</div>
            </div>
          </div>
        </div>
      </div>
