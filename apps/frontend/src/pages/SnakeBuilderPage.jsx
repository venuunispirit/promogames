      ...
      <div style={{
        ...
        <div style={{ display:'flex', gap:6, alignItems:'flex-start', justifySelf:'start' }}>
          ...
          <div>
            ...
            <div style={{ fontSize:9.5, fontWeight:600, color:'var(--gb-text3)', letterSpacing:'.04em', textTransform:'uppercase', marginTop:1 }}>Snake Builder</div>
          </div>
        </div>
            ...
            <div>
              <div className="gb-card" style={{ marginBottom:16, padding:16 }}>
                ...
                <div className="gb-row">
                  <div className="gb-fg">
                    <span className="gb-label">Board Width</span>
                  ...
                  <div className="gb-fg">
                    <span className="gb-label">Board Height</span>
                  ...
                  <div className="gb-fg">
                    <span className="gb-label">Speed (1-20)</span>
              ...
              <div className="gb-card" style={{ marginBottom:16, padding:16 }}>
                <div className="gb-section-title">Snake Colors</div>
                <div className="gb-row">
                ...
                <div className="gb-fg" style={{ marginTop:12 }}>
                  <span className="gb-label">Wall Mode</span>
