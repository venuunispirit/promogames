...
export default function StackBuilderPage() {
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      const fields = ['block_width','block_height','base_speed','speed_increase','block_color','block_color_2',
      ...
      await api.put(`/stack/${id}/settings`, fd)
    ...
    <>
      <div className="gb-section">
        ...
        <div className="gb-row">
          <div className="gb-field"><label>Block Width</label><input type="number" value={s('block_width', 200)} onChange={e => set('block_width', e.target.value)} /></div>
          <div className="gb-field"><label>Block Height</label><input type="number" value={s('block_height', 30)} onChange={e => set('block_height', e.target.value)} /></div>
          <div className="gb-field"><label>Base Speed</label><input type="number" step="0.1" value={s('base_speed', 3)} onChange={e => set('base_speed', e.target.value)} /></div>
          <div className="gb-field"><label>Speed Increase</label><input type="number" step="0.01" value={s('speed_increase', 0.15)} onChange={e => set('speed_increase', e.target.value)} /></div>
        </div>
        <div className="gb-row" style={{ marginTop: 8 }}>
          <ColorPicker value={s('block_color', '#6366f1')} onChange={v => set('block_color', v)} label="Block Color" />
          <ColorPicker value={s('block_color_2', '#4f46e5')} onChange={v => set('block_color_2', v)} label="Block Color 2" />
        </div>
      </div>
      <div className="gb-section">
      ...
      <div className="gb-section">
        ...
        <div className="gb-row" style={{ marginTop: 8 }}>
          <div className="gb-field"><label>Start Button Text</label><input value={s('start_button_text', 'Start Stacking')} onChange={e => set('start_button_text', e.target.value)} /></div>
  ...
  const renderSounds = () => (
    <div className="gb-section">
      ...
      <div className="gb-row">
        <SoundSelector label="Place Sound" value={s('sound_place_id')} onChange={v => set('sound_place_id', v)} sounds={sounds} />
        <SoundSelector label="Slice Sound" value={s('sound_slice_id')} onChange={v => set('sound_slice_id', v)} sounds={sounds} />
        ...
        <div className="gb-h-left">
          ...
          <div>
            {editingName ? (
              ...
              <h1 className="gb-title" onClick={() => { setNameInput(game?.name || ''); setEditingName(true) }}>{game?.name || 'Stack Game'}</h1>
            )}
            <div className="gb-subtitle">🏗️ Stack</div>
          </div>
        </div>
          ...
          <div className="gb-phone">
            <div style={{ padding: 16, textAlign: 'center' }}>
              ...
              <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                <div style={{ width: 100, height: 20, background: s('block_color', '#6366f1'), borderRadius: 3 }} />
                <div style={{ width: 80, height: 20, background: s('block_color_2', '#4f46e5'), borderRadius: 3 }} />
                <div style={{ width: 60, height: 20, background: s('block_color', '#6366f1'), borderRadius: 3 }} />
              </div>
              <div style={{ marginTop: 12, fontSize: 12, color: '#666' }}>Stack Preview</div>
            </div>
          </div>
        </div>
      </div>
