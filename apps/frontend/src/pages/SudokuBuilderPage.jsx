...
export default function SudokuBuilderPage() {
  const { id } = useParams()
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      const fields = ['difficulty','grid_size',
      ...
      await api.put(`/sudoku/${id}/settings`, fd)
    ...
    <>
      <div className="gb-section">
        ...
        <div className="gb-row">
          ...
          <div className="gb-field"><label>Grid Size</label><input type="number" value={s('grid_size', 9)} onChange={e => set('grid_size', e.target.value)} /></div>
        </div>
      </div>
      <div className="gb-section">
      ...
      <div className="gb-section">
        ...
        <div className="gb-row" style={{ marginTop: 8 }}>
          ...
          <ColorPicker value={s('start_button_bg_color', '#3b82f6')} onChange={v => set('start_button_bg_color', v)} label="Button BG" />
    ...
    <>
      <div className="gb-section">
        ...
        <div className="gb-row">
          ...
          <ColorPicker value={s('primary_color', '#3b82f6')} onChange={v => set('primary_color', v)} label="Primary Color" />
        </div>
        ...
        <div className="gb-h-left">
          ...
          <div>
            {editingName ? (
              ...
              <h1 className="gb-title" onClick={() => { setNameInput(game?.name || ''); setEditingName(true) }}>{game?.name || 'Sudoku Game'}</h1>
            )}
            <div className="gb-subtitle">🔢 Sudoku</div>
          </div>
        </div>
        ...
        <div className="gb-phone-col">
          <div className="gb-phone">
            <div style={{ padding: 16, textAlign: 'center' }}>
              ...
              <div style={{ marginTop: 8, fontSize: 12, color: '#666' }}>{s('difficulty', 'medium')} · {s('grid_size', 9)}×{s('grid_size', 9)}</div>
            </div>
          </div>
        </div>
      </div>
