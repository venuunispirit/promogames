  ...
  const saveDisplaySettings = async () => {
    ...
    try {
      ...
      const sFields = ['heading_1','heading_2','heading_3','description_text','intro_text','meta_description','font_family',
        ...
        'sound_correct_id','sound_wrong_id','send_email']
        ...
        <div style={{ minWidth:0 }}>
          ...
          {tab === 'email' && (
            <div className="ws-card">
              ...
              <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:12, padding:'8px 12px', background:'#f0fdf4', border:'1px solid #bbf7d0', borderRadius:8 }}>
