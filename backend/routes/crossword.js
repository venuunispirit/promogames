    ...
    if (existing.length === 0) {
      await db.query(
        ...
        [req.params.gameId, grid_rows || 10, grid_cols || 10, cell_size || 40,
         show_timer !== undefined ? show_timer : 1, time_limit_seconds || 0, allow_hints !== undefined ? allow_hints : 1,
      ...
      await db.query(
        ...
        [grid_rows || e.grid_rows, grid_cols || e.grid_cols, cell_size || e.cell_size,
         show_timer !== undefined ? show_timer : e.show_timer,
         time_limit_seconds !== undefined ? time_limit_seconds : e.time_limit_seconds,
         allow_hints !== undefined ? allow_hints : e.allow_hints,
