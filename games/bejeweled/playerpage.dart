...
Widget buildBejeweledPlayer(GameConfig config, GameFinished onFinished) {
  return BejeweledPlayerPage(config: config, onFinished: onFinished);
}

class BejeweledPlayerPage extends StatefulWidget {
  final GameConfig config;
  final GameFinished onFinished;
  const BejeweledPlayerPage({super.key, required this.config, required this.onFinished});

  @override
  State<BejeweledPlayerPage> createState() => _BejeweledPlayerPageState();
}

class _BejeweledPlayerPageState extends State<BejeweledPlayerPage> {
  late final BejeweledEngine _engine;
  late Color _bgColor;
  ...
  void initState() {
    ...
    _engine = BejeweledEngine(settings: s);
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Text('Tap two adjacent gems',
                  ...
                  child: Padding(
                    ...
                    child: GridView.builder(
                      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: BejeweledEngine.n,
                        crossAxisSpacing: 2,
                        mainAxisSpacing: 2,
                      ),
                      itemCount: BejeweledEngine.n * BejeweledEngine.n,
                      itemBuilder: (ctx, idx) {
                        final r = idx ~/ BejeweledEngine.n;
                        final c = idx % BejeweledEngine.n;
