...
export default function CrosswordRedemptionLogsPage() {
  const { id } = useParams()
  ...
  const exportCSV = () => {
    ...
    a.href = url; a.download = `Crossword_Redemption_Logs.csv`; a.click()
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",padding:'24px 0'}}>
      <div style={{padding:'0 24px',maxWidth:1200,margin:'0 auto'}}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:24}}>
          <div style={{display:'flex',alignItems:'center',gap:14}}>
            ...
            <div>
              ...
              <p style={{fontSize:13.5,color:'var(--text3)',marginTop:4}}>🐍 Redemption audit for this crossword game</p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div style={{textAlign:'center',padding:40,color:'var(--text3)'}}>No redemptions found for this crossword game</div>
        ) : (
