...
export default function LudoBuilderPage() {
  const { id }   = useParams()
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      await api.put(`/ludo/${id}/settings`, fd)
          ...
          <div>
            ...
            <div className="gb-card" style={{ marginBottom:16, padding:16 }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr auto', gap:'8px 16px', alignItems:'end' }}>
                <div className="gb-fg" style={{ marginBottom:0 }}>
                  ...
                  <input value={settings.heading_1||''} onChange={e => setSettings({...settings,heading_1:e.target.value})} placeholder="Master Ludo" />
                </div>
            ...
            <div className="gb-card" style={{ marginBottom:16, padding:16 }}>
              ...
              <div className="gb-row">
                <div className="gb-fg">
                  ...
                  <input value={slugInput} onChange={e => setSlugInput(e.target.value)} placeholder="my-ludo-game" />
                </div>
                <div className="gb-fg">
            ...
            <div className="gb-card" style={{ marginBottom:16, padding:16 }}>
              ...
              <div className="gb-fg">
                ...
                <textarea rows={2} value={settings.meta_description||''} onChange={e => setSettings({...settings,meta_description:e.target.value})} style={{ resize:'vertical' }} placeholder="A fun Ludo board game..." />
              </div>
            </div>
