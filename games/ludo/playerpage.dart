...
Widget buildLudoPlayer(GameConfig config, GameFinished onFinished) {
  return LudoPlayerPage(config: config, onFinished: onFinished);
}

class LudoPlayerPage extends StatefulWidget {
  final GameConfig config;
  final GameFinished onFinished;
  const LudoPlayerPage({super.key, required this.config, required this.onFinished});

  @override
  State<LudoPlayerPage> createState() => _LudoPlayerPageState();
}

class _LudoPlayerPageState extends State<LudoPlayerPage> {
            ...
            builder: (_, __) => Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('You: ${_engine.playerTokens}/4  |  AI: ${_engine.aiTokens}/4',
