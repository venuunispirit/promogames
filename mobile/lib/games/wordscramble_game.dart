...
Widget buildWordScrambleGame(Map<String, dynamic> settings, GameFinished onFinished) {
  return _WordScrambleGame(settings: settings, onFinished: onFinished);
}

class _WordScrambleGame extends StatefulWidget {
  final Map<String, dynamic> settings;
  final GameFinished onFinished;
  const _WordScrambleGame({required this.settings, required this.onFinished});
